...
export function HomePage() {
  ...
  const traditionalFoods = foods.filter(food => food.category === "traditional");
  const modernFoods = foods.filter(food => food.category === "modern");
  const drinks = foods.filter(food => food.category === "drinks");
  const featuredFoods = foods.filter(food => food.is_featured);
    ...
    <div>
      ...
      <section id="traditional" className="py-16 bg-parchment">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-gray-600 mt-2 mb-8">Authentic recipes passed down through generations</p>
      ...
      <section id="modern" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-gray-600 mt-2 mb-8">Contemporary favorites with a local twist</p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <section id="drinks" className="py-16 bg-parchment">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-gray-600 mt-2 mb-8">Refreshing beverages to complement your meal</p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {drinks.map(food => (
              <FoodCard key={food._id || food.id} food={food} />
            ))}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-serif font-bold text-center mb-12">Popular Dishes</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4 text-lg leading-relaxed">
                Dire Foods was created with a passion to deliver delicious meals quickly and reliably.
              </p>
              <p className="text-gray-600 text-lg leading-relaxed">
                We specialize in fast food delivery, combining traditional Ethiopian-inspired dishes with popular modern meals.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="contact" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-serif font-bold text-center text-clay mb-12">Contact Us</h2>
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                <Phone className="w-6 h-6 text-clay" />
                <div>
              ...
              <div className="flex items-center gap-4">
                <Mail className="w-6 h-6 text-clay" />
                <div>
